...
map<pid_t, int> system_struct_t::tid_core_map;
int* system_struct_t::core_tid_map;
...
int system_struct_t::detect_system() {
	...
	core_tid_map = (int*)malloc(NUM_OF_CORES*sizeof(int));
...
int system_struct_t::get_tid_core(pid_t tid){
